...
async function selectHotProduct() {
    ...
    var sql = "SELECT product_name, product_price, product_cnt, product_img, product_no FROM product ORDER BY product_views DESC";
...
async function selectLiveProduct() {
  ...
  var sql = "SELECT product_name, product_content, product_img, product_no FROM product ORDER BY product_reg DESC";
